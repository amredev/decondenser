...
pub(crate) struct Config {
    ...
    // #[facet(flatten)] together with #[facet(deny_unknown_fields)]
...
#[derive(Facet)]
#[facet(deny_unknown_fields, sadasdsad)]
#[repr(u8)]
enum Punct {
    Content(String),
    Extended {
